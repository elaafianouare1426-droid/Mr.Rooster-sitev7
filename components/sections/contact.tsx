      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-start ${isRtl ? 'direction-rtl' : ''}`}>
          ...
          <div className={`space-y-8 ${isRtl ? 'text-right' : 'text-left'}`}>
            ...
            {/* عرض الأيقونات في سطر واحد (2 columns) حتى في الموبايل */}
            <div className="grid grid-cols-2 gap-4 text-center">
              <a href="https://wa.me/212600000000" className="flex flex-col items-center p-4 bg-white border border-orange-100 rounded-[2rem] hover:shadow-lg transition-all group">
              ...
              <a href="tel:+212600000000" className="flex flex-col items-center p-4 bg-white border border-orange-100 rounded-[2rem] hover:shadow-lg transition-all group">
          ...
          {/* نموذج المراسلة مع خيار طلب موعد زيارة */}
          <div className="bg-white p-6 sm:p-8 rounded-[2.5rem] border border-orange-50 shadow-2xl shadow-orange-900/5">
            ...
            <div className={`space-y-4 ${isRtl ? 'text-right' : 'text-left'}`}>
              ...
              <textarea placeholder={isRtl ? 'أكتب رسالتك هنا...' : 'Tell us about your requirements...'} className="w-full p-4 rounded-xl border border-orange-100 min-h-[100px] outline-none focus:border-orange-500 resize-none"></textarea>
