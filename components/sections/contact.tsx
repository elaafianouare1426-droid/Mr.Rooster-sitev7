...
// استخدم التصدير المسمى (Named Export) ليطابق استيرادك في page.tsx
    ...
    <section id="contact" className="py-20 bg-white border-t border-orange-50">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          {/* الجانب الأيسر: أزرار الاتصال مع الأسماء المطلوبة */}
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-orange-50 shadow-2xl shadow-orange-900/5">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <input type="text" placeholder="Name" className="w-full h-12 px-4 rounded-xl border border-orange-100 outline-none focus:border-orange-500 transition-all" />
                <input type="email" placeholder="Email" className="w-full h-12 px-4 rounded-xl border border-orange-100 outline-none focus:border-orange-500 transition-all" />
              </div>
              <input type="tel" placeholder="Phone Number" className="w-full h-12 px-4 rounded-xl border border-orange-100 outline-none focus:border-orange-500 transition-all" />
              <textarea placeholder="Tell us about your requirements..." className="w-full p-4 rounded-xl border border-orange-100 min-h-[120px] outline-none focus:border-orange-500 resize-none transition-all"></textarea>
              <button className="w-full h-14 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-2xl shadow-lg shadow-orange-600/20 transition-all flex items-center justify-center gap-2">
